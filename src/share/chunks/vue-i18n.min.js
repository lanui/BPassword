  ...
  (e = function () {
    ...
    function u() {
      ...
      return (
        1 === t.length
          ...
          : 2 === t.length &&
            ('string' == typeof t[0] && (a = t[0]), (r(t[1]) || n(t[1])) && (i = t[1])),
        { locale: a, params: i }
      );
    }
    function f(t) {
          ...
          (t.i18n = t.i18n || (t.__i18n ? {} : null)),
            t.i18n
              ? t.i18n instanceof nt
                ...
                : s(t.i18n) && (this._i18n.subscribeDataChanging(this), (this._subscribing = !0))
              : this.$root && this.$root.$i18n && this.$root.$i18n instanceof nt
              ? (this._i18n.subscribeDataChanging(this), (this._subscribing = !0))
              : t.parent &&
                t.parent.$i18n &&
        ...
        render: function (t, e) {
          ...
          if (o) {
            var s = a.path,
              ...
              h = (a.tag && !0 !== a.tag) || !1 === a.tag ? a.tag : 'span';
            return h ? t(h, n, f) : f;
          }
        },
      };
        ...
        render: function (e, n) {
          ...
          var f = i.locale || l.locale,
            ...
            m = p.map(function (t, e) {
              ...
              return r
                ? r((((n = {})[t.type] = t.value), (n.index = e), (n.parts = p), n))
                : t.value;
            }),
    ...
    function C(t, n, r, a) {
      if (r.context) {
        ...
        n.modifiers.preserve || i.preserveDirectiveContent || (t.textContent = ''),
          (t._vt = void 0),
          delete t._vt,
          (t._locale = void 0),
          delete t._locale,
    ...
    function T(t, n) {
      var r = n.context;
      return r
        ? !!r.$i18n || (e('VueI18n instance does not exists in Vue instance'), !1)
    ...
    function L(t, n, r) {
      ...
      if (c || u || f)
        if (c) {
          ...
          (t._vt = t.textContent =
            null != h
              ? (i = p.$i18n).tc.apply(i, [c, h].concat(D(u, f)))
              : (o = p.$i18n).t.apply(o, [c].concat(D(u, f)))),
          ...
          ((n = (function (t) {
            ...
            for (; n < t.length; ) {
              ...
              if ('{' === a) {
                ...
                var o = '}' === a,
                  s = x.test(i) ? 'list' : o && W.test(i) ? 'named' : 'unknown';
    ...
    (B[P] = { ws: [P], ident: [3, j], '[': [R], eof: [A] }),
      ...
      (B[R] = { "'": [V, j], '"': [E, j], '[': [R, S], ']': [1, H], eof: z, else: [R, j] }),
      (B[V] = { "'": [R, j], eof: z, else: [V, j] }),
      (B[E] = { '"': [R, j], eof: z, else: [E, j] });
    ...
    function J(t) {
      ...
      return (
        ...
        ((r = a),
        U.test(r)
          ? (n = (e = a).charCodeAt(0)) !== e.charCodeAt(e.length - 1) || (34 !== n && 39 !== n)
            ? e
            : e.slice(1, -1)
          : '*' + a)
      );
          ...
          ((e = (function (t) {
            ...
            for (
              ...
              if ('\\' !== (e = t[++c]) || !p()) {
                ...
                if (
                  ((u = i[0]), (o = h[i[1]]) && ((r = void 0 === (r = i[2]) ? e : r), !1 === o()))
                )
                  return;
                if (u === A) return l;
              }
    ...
    return (
        ...
        var o = function (t, r, i, l) {
          if (s(i))
            Object.keys(i).forEach(function (e) {
              var n = i[e];
              s(n)
                ? (l.push(e), l.push('.'), o(t, r, n, l), l.pop(), l.pop())
                : (l.push(e), o(t, r, n, l), l.pop());
            });
          else if (n(i))
            i.forEach(function (e, n) {
              s(e)
                ? (l.push('[' + n + ']'), l.push('.'), o(t, r, e, l), l.pop(), l.pop())
      ...
      (nt.prototype._getLocaleChain = function (t, e) {
        ...
        if (!i) {
          ...
          (s = a((o = n(e) ? e : r(e) ? (e.default ? e.default : null) : e)) ? [o] : o) &&
            this._appendBlockToChain(i, s, null),
      ...
      (nt.prototype._t = function (t, e, n, r) {
        ...
        this._escapeParameterHtml &&
          (l.params =
            ...
            s));
        var c = l.locale || e,
          f = this._translate(n, c, this.fallbackLocale, t, r, 'string', l.params);
        if (this._isFallbackRoot(f)) {
          if (!this._root) throw Error('unexpected error');
          return (a = this._root).$t.apply(a, [t].concat(i));
        }
        return (
          (f = this._warnDefault(c, t, f, r, i, 'string')),
          this._postTranslation && null != f && (f = this._postTranslation(f, t)),
          f
        );
      }),
      ...
      (nt.prototype.mergeLocaleMessage = function (t, e) {
        ('warn' !== this._warnHtmlInMessage && 'error' !== this._warnHtmlInMessage) ||
          this._checkLocaleMessage(t, this._warnHtmlInMessage, e),
          this._vm.$set(this._vm.messages, t, _({}, this._vm.messages[t] || {}, e));
      }),
      ...
      (nt.prototype.mergeDateTimeFormat = function (t, e) {
        this._vm.$set(this._vm.dateTimeFormats, t, _(this._vm.dateTimeFormats[t] || {}, e)),
      ...
      (nt.prototype._localizeDateTime = function (t, e, n, r, a) {
        ...
        return p || (p = this._dateTimeFormatters[h] = new Intl.DateTimeFormat(i, f)), p.format(t);
      }),
      ...
      (nt.prototype.d = function (t) {
        ...
        return (
          1 === e.length
            ? a(e[0])
              ? (o = e[0])
              : r(e[0]) && (e[0].locale && (i = e[0].locale), e[0].key && (o = e[0].key))
      ...
      (nt.prototype.mergeNumberFormat = function (t, e) {
        this._vm.$set(this._vm.numberFormats, t, _(this._vm.numberFormats[t] || {}, e)),
      ...
      (nt.prototype.n = function (e) {
        ...
        return (
          1 === n.length
            ...
            : 2 === n.length && (a(n[0]) && (s = n[0]), a(n[1]) && (o = n[1])),
          this._n(e, o, s, l)
        );
      }),
