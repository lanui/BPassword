...
(t = this),
  (e = function () {
    ...
    function $(t, e) {
      ...
      return function (e, n) {
        for (
          var o = '', i = e || {}, a = (n || {}).pretty ? S : encodeURIComponent, s = 0;
          s < t.length;
          s++
        ) {
          var u = t[s];
      ...
      D = {
        ...
        render: function (e) {
          var r = this,
            ...
            w = s.redirectedFrom ? p(null, B(s.redirectedFrom), null, n) : s;
          (f[g] = v(o, w)),
            (f[m] = this.exact
              ? f[g]
              : (function (t, e) {
          ...
          if ('a' === this.tag) (R.on = k), (R.attrs = { href: u, 'aria-current': b });
          else {
            var C = (function t(e) {
              if (e)
    ...
    function Y(t, e) {
      ...
      function a(t, r, a) {
        ...
        if (s.path) {
          ...
          for (var l = 0; l < n.length; l++) {
            var d = n[l],
              v = o[d];
            if (W(v.regex, s.path, s.params)) return u(v, s, a);
          }
        }
        return u(null, s);
      }
      function s(t, r) {
        ...
        var s = o,
          ...
          d = r.params;
        return (
          (h = s.hasOwnProperty('query') ? s.query : h),
    ...
    (St.prototype.listen = function (t) {
      ...
      (St.prototype.confirmTransition = function (t, e, r) {
        ...
        var p = (function (t, e) {
          ...
          y = function (e, r) {
            if (n.pending !== t) return s(bt(o, t));
            try {
              e(t, o, function (e) {
                !1 === e
                  ? (n.ensureURL(!0),
                  ...
                  ? (s(wt(o, t)), 'object' == typeof e && e.replace ? n.replace(e) : n.push(e))
                  : r(e);
              });
            } catch (t) {
              s(t);
    ...
    var Tt = (function (t) {
      function e(e, r) {
        t.call(this, e, r), (this._startLocation = Lt(this.base));
      }
      return (
        t && (e.__proto__ = t),
    ...
    return (
      ...
      (Ft.prototype.init = function (t) {
        ...
        if (
          ...
          this.app = t;
          var r = this.history;
          if (r instanceof Tt || r instanceof qt) {
            var n = function (t) {
              r.setupListeners(),
                (function (t) {
                  var n = r.current,
