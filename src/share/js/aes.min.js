!(function (t) {
  ...
  function i(t) {
    ...
    for (var e = 0; e < t.length; e++) if (!r(t[e]) || t[e] < 0 || 255 < t[e]) return !1;
    return !0;
  }
  function s(t, e) {
      ...
      fromBytes: function (t) {
        for (var e = [], r = 0; r < t.length; ) {
          ...
          i < 128
            ...
            : 191 < i && i < 224
            ? (e.push(String.fromCharCode(((31 & i) << 6) | (63 & t[r + 1]))), (r += 2))
            : (e.push(
                String.fromCharCode(((15 & i) << 12) | ((63 & t[r + 1]) << 6) | (63 & t[r + 2]))
              ),
              (r += 3));
        }
        return e.join('');
  ...
  var A = function (t) {
    ...
    Object.defineProperty(this, 'key', { value: s(t, !0) }), this._prepare();
  };
  (A.prototype._prepare = function () {
    ...
    var r,
      ...
      s = S(this.key);
    for (e = 0; e < n; e++)
      (r = e >> 2), (this._Ke[r][e % 4] = s[e]), (this._Kd[t - r][e % 4] = s[e]);
    for (var o, h = 0, a = n; a < i; ) {
      if (
        ((o = s[n - 1]),
        (s[0] ^=
          (p[(o >> 16) & 255] << 24) ^
        ...
        for (e = 1; e < n; e++) s[e] ^= s[e - 1];
      else {
        for (e = 1; e < n / 2; e++) s[e] ^= s[e - 1];
        (o = s[n / 2 - 1]),
          (s[n / 2] ^=
            p[255 & o] ^
            (p[(o >> 8) & 255] << 8) ^
            (p[(o >> 16) & 255] << 16) ^
            (p[(o >> 24) & 255] << 24));
        for (e = n / 2 + 1; e < n; e++) s[e] ^= s[e - 1];
      }
      for (e = 0; e < n && a < i; )
        (f = a >> 2), (u = a % 4), (this._Ke[f][u] = s[e]), (this._Kd[t - f][u] = s[e++]), a++;
    }
    for (var f = 1; f < t; f++)
      for (var u = 0; u < 4; u++)
        (o = this._Kd[f][u]),
          (this._Kd[f][u] =
            b[(o >> 24) & 255] ^ E[(o >> 16) & 255] ^ C[(o >> 8) & 255] ^ z[255 & o]);
  }),
    (A.prototype.encrypt = function (t) {
      ...
      for (n = 0; n < 4; n++)
        (o = this._Ke[e][n]),
          (h[4 * n] = 255 & (p[(i[n] >> 24) & 255] ^ (o >> 24))),
          (h[4 * n + 1] = 255 & (p[(i[(n + 1) % 4] >> 16) & 255] ^ (o >> 16))),
          (h[4 * n + 2] = 255 & (p[(i[(n + 2) % 4] >> 8) & 255] ^ (o >> 8))),
          (h[4 * n + 3] = 255 & (p[255 & i[(n + 3) % 4]] ^ o));
      return h;
    }),
    (A.prototype.decrypt = function (t) {
      ...
      for (n = 0; n < 4; n++)
        (o = this._Kd[e][n]),
          (h[4 * n] = 255 & (f[(i[n] >> 24) & 255] ^ (o >> 24))),
          (h[4 * n + 1] = 255 & (f[(i[(n + 3) % 4] >> 16) & 255] ^ (o >> 16))),
          (h[4 * n + 2] = 255 & (f[(i[(n + 2) % 4] >> 8) & 255] ^ (o >> 8))),
          (h[4 * n + 3] = 255 & (f[255 & i[(n + 1) % 4]] ^ o));
      return h;
    });
  var K = function (t) {
  ...
  (K.prototype.encrypt = function (t) {
    if ((t = s(t)).length % 16 != 0)
      throw new Error('invalid plaintext size (must be multiple of 16 bytes)');
    for (var e = a(t.length), r = a(16), i = 0; i < t.length; i += 16)
      o(t, r, 0, i, i + 16), o((r = this._aes.encrypt(r)), e, i);
    return e;
  }),
    (K.prototype.decrypt = function (t) {
      ...
      for (var e = a(t.length), r = a(16), i = 0; i < t.length; i += 16)
        o(t, r, 0, i, i + 16), o((r = this._aes.decrypt(r)), e, i);
      return e;
    });
  var x = function (t, e) {
    ...
    (this._lastCipherblock = s(e, !0)), (this._aes = new A(t));
  };
  (x.prototype.encrypt = function (t) {
    ...
    (x.prototype.decrypt = function (t) {
      ...
      for (var e = a(t.length), r = a(16), i = 0; i < t.length; i += 16) {
        ...
        for (var n = 0; n < 16; n++) e[i + n] = r[n] ^ this._lastCipherblock[n];
  ...
  var k = function (t, e, r) {
    ...
    r || (r = 1), (this.segmentSize = r), (this._shiftRegister = s(e, !0)), (this._aes = new A(t));
  };
  (k.prototype.encrypt = function (t) {
    if (t.length % this.segmentSize != 0)
      throw new Error('invalid plaintext size (must be segmentSize bytes)');
    for (var e, r = s(t, !0), i = 0; i < r.length; i += this.segmentSize) {
      e = this._aes.encrypt(this._shiftRegister);
      for (var n = 0; n < this.segmentSize; n++) r[i + n] ^= e[n];
  ...
  var I = function (t, e) {
    ...
    (this._lastPrecipher = s(e, !0)), (this._lastPrecipherIndex = 16), (this._aes = new A(t));
  };
  (I.prototype.encrypt = function (t) {
    for (var e = s(t, !0), r = 0; r < e.length; r++)
  ...
  var j = {
    AES: A,
    Counter: P,
    ModeOfOperation: { ecb: K, cbc: x, cfb: k, ofb: I, ctr: R },
    utils: { hex: h, utf8: e },
    padding: {
      pkcs7: {
        pad: function (t) {
          var e = 16 - ((t = s(t, !0)).length % 16),
            r = a(t.length + e);
          o(t, r);
        ...
        strip: function (t) {
          if ((t = s(t, !0)).length < 16) throw new Error('PKCS#7 invalid length');
          var e = t[t.length - 1];
          ...
          var n = a(r);
          return o(t, n, 0, 0, r), n;
        },
      },
    },
    _arrayTest: { coerceArray: s, createArray: a, copyArray: o },
  };
  'undefined' != typeof exports
    ...
    : (t.aesjs && (j._aesjs = t.aesjs), (t.aesjs = j));
})(this);
